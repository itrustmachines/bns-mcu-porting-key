...
static int secp256k1_fe_set_b32(secp256k1_fe *r, const unsigned char *a) {
  ...
  ret =
      !((r->n[9] == 0x3FFFFFUL) & ((r->n[8] & r->n[7] & r->n[6] & r->n[5] & r->n[4] & r->n[3] & r->n[2]) == 0x3FFFFFFUL)
...
SECP256K1_INLINE static void secp256k1_fe_mul_inner(
    uint32_t *r,
    const uint32_t *a,
...
static SECP256K1_INLINE void secp256k1_fe_storage_cmov(
