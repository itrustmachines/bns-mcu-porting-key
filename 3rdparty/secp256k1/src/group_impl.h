...
static void secp256k1_ge_globalz_set_table_gej(
    size_t len,
    secp256k1_ge *r,
...
static void secp256k1_gej_add_ge_var(
    secp256k1_gej *r,
    const secp256k1_gej *a,
...
static void secp256k1_gej_add_zinv_var(
    secp256k1_gej *r,
    const secp256k1_gej *a,
    const secp256k1_ge *b,
...
static SECP256K1_INLINE void secp256k1_ge_storage_cmov(
